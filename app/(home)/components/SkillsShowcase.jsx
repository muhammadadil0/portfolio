...
import { FaGithub, FaPython, FaPhp } from 'react-icons/fa';
import { SiDjango, SiMongodb, SiFlutter, SiFigma, SiMysql, SiTensorflow, SiJavascript, SiDart, SiFlask, SiPandas, SiScikitlearn, SiFirebase } from 'react-icons/si';
import { TbBrandCpp } from 'react-icons/tb';

const skills = [
    { name: "Python", icon: <FaPython className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    { name: "Flutter", icon: <SiFlutter className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    ...
    { name: "JavaScript", icon: <SiJavascript className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    ...
    { name: "Flask", icon: <SiFlask className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    { name: "Figma", icon: <SiFigma className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "C/C++", icon: <TbBrandCpp className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Firebase", icon: <SiFirebase className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Pandas", icon: <SiPandas className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Scikit-learn", icon: <SiScikitlearn className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    { name: "PHP", icon: <FaPhp className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
];
